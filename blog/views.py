...
def home(request):
    ...
    d_first_jobs = Job.objects.all().order_by('-date_posted')
    d_second_jobs = Job.objects.all().order_by('-date_posted')
    d_third_jobs = Job.objects.all().order_by('-date_posted')
...
class UserPostListView(ListView):
    ...
    def get_queryset(self):
        ...
        first_jobs = Job.objects.filter(agency=agency_name).order_by('-date_posted')
        second_jobs = Job.objects.filter(agency=agency_name).order_by('-date_posted')
        third_jobs = Job.objects.filter(agency=agency_name).order_by('-date_posted')
